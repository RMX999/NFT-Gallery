...
export default function Header() {
  return (
    <div className="flex items-center justify-around flex-wrap  px-10">
      <div className="max-w-xl text-white my-20">
...
Visit this page regularly to see up-to-date information regarding projects that are gaining popularity.{" "}
      ...
      <div>
        <img src="NFT-Gallery.png" alt="pixi-world" width="600" height="200" />
      </div>
    </div>
  );
}
