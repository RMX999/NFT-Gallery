...
import logo from '../../public/apes.png'
  ...
  return (
    <div className="md:w-[50rem] md:h-[20.5rem] w-[20.5rem] h-[40rem] p-4 rounded-2xl bg-[#232b78] dark:bg-slate-800 shadow-lg dark:shadow-slate-700 flex flex-col ease-linear duration-300 md:flex-row-reverse">
      ...
      <div className=" h-full w-full mr-2 rounded-2xl ">
        {/* <p className="m-2 font-bold pl-1 text-lg text-[#efff13]"></p> */}
        ...
        <div className=" pt-16 pr-2 pl-2 flex flex-row justify-around flex-wrap">
          ...
          <div className="flex flex-row items-center m-2">
            ...
            <h1 className="pl-1 dark:text-white">Floor price 94,0 ETH</h1>
          </div>
          <div className="flex flex-row items-center m-2">
          ...
          <div className="flex flex-row items-center m-2">
            ...
            <h1 className="pl-1 dark:text-white">Supply 10,000</h1>
          </div>
        </div>

        <div className="flex flex-row">
        <Link href="/profile">
          <button className="md:m-2 m-auto mt-8 bg-[#5865F2] shadow-md shadow-[#5865f28a]  pt-2 pb-2 pl-5 pr-4 rounded-xl flex flex-row justify-center items-center hover:bg-[#424bb6] ease-linear duration-300">
